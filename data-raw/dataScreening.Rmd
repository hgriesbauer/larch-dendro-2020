...
# Load data
```{r}
load("dat.RData") # note this file is saved in the data-raw folder
```
...
```
Note that 'W' refers to Willow, as per discussion with Ken.
...
dat[dat$DBH>25,]
```
Seem ok, although some of those trees are prerry wide for their heights.  I'll take a look at some of the plot cards to double check DBH measurements, however, this doesn't seem like a typo.
